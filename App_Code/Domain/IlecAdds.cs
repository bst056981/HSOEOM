...
namespace Agile.Domain
{
    public class IlecAdds {
        ...
        public const string SELECT_ILEC_ADDS =
            "SELECT ILEC_ADDS_ID, DICE, NAME, TYPE, PANEL, DEALER, START_DATE, CYCLE, BRANCH, AMOUNT, REP, SERVICE, TECH, BAN, RATE, ENTERED_DATE, ENTERED_ID FROM ILEC_ADDS WHERE ILEC_ADDS_ID = :ILEC_ADDS_ID";
        public const string INSERT_ILEC_ADDS =
            "INSERT INTO ILEC_ADDS(ILEC_ADDS_ID, DICE, NAME, TYPE, PANEL, DEALER, START_DATE, CYCLE, BRANCH, AMOUNT, REP, SERVICE, TECH, BAN, RATE, ENTERED_DATE, ENTERED_ID) VALUES (:ILEC_ADDS_ID, :DICE, :NAME, :TYPE, :PANEL, :DEALER, :START_DATE, :CYCLE, :BRANCH, :AMOUNT, :REP, :SERVICE, :TECH, :BAN, :RATE, :ENTERED_DATE, :ENTERED_ID)";
        public const string UPDATE_ILEC_ADDS =
            "UPDATE ILEC_ADDS SET DICE = :DICE, NAME = :NAME, TYPE = :TYPE, PANEL = :PANEL, DEALER = :DEALER, START_DATE = :START_DATE, CYCLE = :CYCLE, BRANCH = :BRANCH, AMOUNT = :AMOUNT, REP = :REP, SERVICE = :SERVICE, TECH = :TECH, BAN = :BAN, RATE = :RATE, ENTERED_DATE = :ENTERED_DATE, ENTERED_ID = :ENTERED_ID WHERE ILEC_ADDS_ID = :ILEC_ADDS_ID";
        public const string DELETE_ILEC_ADDS = 
            "DELETE FROM ILEC_ADDS WHERE ILEC_ADDS_ID = :ILEC_ADDS_ID";
        public const string GET_ILEC_ADDS_ID =
          "SELECT ILEC_ADDS_ID_SEQ.NEXTVAL FROM DUAL";
        #endregion
    }
}
