...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="False" DataKeyNames="REC_ID" DataSourceID="dsCustomerCnt" Style="margin-left: -200px"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="CLEC ACCOUNTS" DataField="HEADING2" ReadOnly="true" ItemStyle-HorizontalAlign="Center" />
            ...
            <asp:BoundField HeaderText="DIFF" DataField="DIFF" ReadOnly="true" ItemStyle-HorizontalAlign="Center" />
        </Columns>
    </asp:GridView>
