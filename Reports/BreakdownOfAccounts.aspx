...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="dsCustomerCnt" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
       ...
       (SELECT ADDS FROM BREAKDOWN_ACCOUNTS_VW WHERE DEALER = 'ELEV') AS SOSH,
...
SELECT DISTINCT 'DISCONNECTS' BRANCH,
       ...
       (SELECT DISCONNECTS FROM BREAKDOWN_ACCOUNTS_VW WHERE DEALER = 'ELEV') AS SOSH,
...
SELECT DISTINCT 'NET' BRANCH,
       ...
       (SELECT NET FROM BREAKDOWN_ACCOUNTS_VW WHERE DEALER = 'ELEV') AS SOSH,
